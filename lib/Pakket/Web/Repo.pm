...
sub create {
    ...
    prefix $repo_path => sub {
        ...
        get '/has_object' => with_types [['query', 'id', 'Str', 'MissingID']] => sub {
        ...
        get '/all_object_ids_by_name' =>
            with_types [['query', 'name', 'Str', 'MissingName'], ['query', 'category', 'Str', 'MissingCategory']] =>
            sub {
        ...
        if (!$args->{'read_only'}) {
            prefix '/store' => sub {
                ...
                post '/location' => with_types [['query', 'id', 'Str', 'MissingID']] => sub {
                    my $id   = query_parameters->get('id');
